			...
			<Grid container spacing={2}>
				<Grid item xs={12} md={4}>
					<Box sx={styles.cardStyle}>
						<svg xmlns='http://www.w3.org/2000/svg' {...styles.iconStyle}>
				...
				<Grid item xs={12} md={4}>
					<Box sx={styles.cardStyle}>
						...
						<Typography variant='body2' color={'gray'} textAlign={'center'}>
							Defalcate is most focused on helping you discover your most
							beautiful smile
						</Typography>
					</Box>
				</Grid>
